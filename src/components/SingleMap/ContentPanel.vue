...
<template>
    <div class="contentPanel" :style="{
        ...
        <header class="contentPanel__header">
            <h2 class="contentPanel__h2" v-if="state.isToggled">
                <img class="contentPanel__icon" src="@/assets/ui_logo_beta.webp"
                    alt="">
                <div class="contentPanel__title">Selected lineups</div>
            </h2>
            <div class="controlButtonsContainer">

                <button class="contentPanel__button" v-if="state.isToggled"
                ...
                <button class="contentPanel__button" v-if="state.isToggled" :style="{
                    borderTop: state.isMinimized ? '1px solid var(--border_dark)' : '1px solid var(--border_light)',
                    borderLeft: state.isMinimized ? '1px solid var(--border_dark)' : '1px solid var(--border_light)',
                    borderBottom: state.isMinimized ? '1px solid var(--border_light)' : '1px solid var(--border_dark)',
                    borderRight: state.isMinimized ? '1px solid var(--border_light)' : '1px solid var(--border_dark)'
                ...
                <button class="contentPanel__button" @click="emit('toggle')" :style="{
                    ...
                    <svg v-if="!state.isToggled" class="feather feather-maximize-2" stroke-linecap="round"
        ...
        <div class="contentPanel__content" v-if="state.isToggled" :style="{
