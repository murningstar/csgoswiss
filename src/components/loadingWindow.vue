<template>
     <aside class="loadingWindow">
          <p class="loadingTitle">Loading...</p>
          <p class="loadingInfo">Downloading map image...</p>
          <div class="progressBar">
               <div class="progressSegment" v-for="segment in 21">
                    <div
                         class="progressSegmentCrutch"
                         :style="{
                              visibility:
