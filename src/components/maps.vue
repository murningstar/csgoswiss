<template>
	<!--
		...
		там работают компоненты я просто хз). Моя догадка заключается в том что... как мне
		кажется - на каждый отдельный маршрут(/mirage,/dust2...) должен быть отдельный view
		или че-то типо того.
	-->
